...
from pytorchlab.experiments.dcgan.torch_model import (
    Discriminator,
    Generator,
    _Discriminator,
    _Generator,
...
class DCGANModule(LightningModule):
    def __init__(
        self,
        latent_dim: int,
        ...
        DOI:
            - arxiv: https://doi.org/10.48550/arXiv.1511.06434
            - Springer: https://doi.org/10.1007/978-3-319-71589-6_9
